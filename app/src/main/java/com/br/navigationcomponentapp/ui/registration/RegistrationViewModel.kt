package com.br.navigationcomponentapp.ui.registration
...
class RegistrationViewModel : ViewModel() {
    ...
    companion object {
        val INPUT_NAME = "INPUT_NAME" to R.string.profile_data_input_hint_name
        val INPUT_BIO = "INPUT_BIO" to R.string.profile_data_input_hint_name
        val INPUT_USERNAME = "INPUT_USERNAME" to R.string.choose_credentials_input_hint_username
        val INPUT_PASSWORD = "INPUT_PASSWORD" to R.string.choose_credentials_input_hint_password
    }
