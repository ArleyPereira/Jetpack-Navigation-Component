...
class LoginViewModel : ViewModel() {
    ...
    companion object {
        val INPUT_USERNAME = "INPUT_USERNAME" to R.string.login_input_error_invalid_username
        val INPUT_PASSWORD = "INPUT_PASSWORD" to R.string.login_input_error_invalid_password
    }
